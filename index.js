...
/*
  TASK 2
    ...
    x STRETCH: Give cars ability to `.drive(distance)`. The distance driven:
        + Should cause the `odometer` to go up.
        + Should cause the the `tank` to go down taking `milesPerGallon` into account.
    x STRETCH: A car which runs out of `fuel` while driving can't drive any more distance:
...
// use object.create here

/* 
  TASK 4

  In your own words explain the four principles for the "this" keyword below:
  1. Window Global Object Binding: when used in global scope, the browser window is the object
  2. Implicit Binding: binding this to an object when using a method to call the object
  3. New Binding: used in constructor functions
  4. Explicit Binding: used with call and apply
*/
